...
export const getUM = async (id) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/UnitsOfMeasure/${id}`);
...
export const addUM = async (UMData) => {
  ...
  try {
    const response = await axios.post(`${API_BASE_URL}/UnitsOfMeasure`, UMData);
    return response.data;
  } catch (error) {
...
export const updateUM = async (UMData) => {
  try {
    const response = await axios.put(`${API_BASE_URL}/UnitsOfMeasure/${UMData.id}`, UMData);
...
export const getAllUMs = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/UnitsOfMeasure`);
...
export const deleteUM = async (id) => {
  try {
    const response = await axios.delete(`${API_BASE_URL}/UnitsOfMeasure/${id}`);
    return response.status === 200; // Return true if the status code is 200 (OK)
  } catch (error) {
